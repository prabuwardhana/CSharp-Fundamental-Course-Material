...
namespace WorkingWithDelegates
{
    public class Demo1
    {
        public static void Run()
        {
            ...
            // Now the invocation of SimpleMath.Add() can be delegated to object 'add'
            Console.WriteLine("add.Invoke: 10 + 20 = {0}", simpleMathAdd.Invoke(10, 20));
            // Alternatively, you can invoke the delegate simply like below.
            Console.WriteLine("add: 10 + 20 = {0}", simpleMathAdd(10, 20));
            ...
            // // Error! No overload for 'Square' matches delegate 'Program.ArithmeticOp'
            // ArithmeticOp square = new ArithmeticOp(SimpleMath.Square);

            // .NET delegates can also point to instance methods as well.
            SimpleMath simpleMath = new SimpleMath();
            SimpleMathDelegate simpleMathSub = new SimpleMathDelegate(simpleMath.Subtract);
